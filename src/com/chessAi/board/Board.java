...
public final class Board {
    ...
    private static final Board STANDARD_BOARD = initialisationOfPiecesInBoard();
// configuration d'echiquier
...
// creation d'un echiquie qui contient des case de 0 à 63
    // on va mappe une piece a une case id
    @Override
    public String toString() {
        final StringBuilder builder = new StringBuilder();
        for (int i = 0; i < BoardUtils.NUM_TILES; i++) {
            final String tileText = AffichageTerminal(this.boardConfig.get(i));
...
// pour l affichage dans le terminal noire en minuscule et blanc en majuscule
    // et une case vide avec -
    private static String AffichageTerminal(final Piece piece) {
        if(piece != null) {
...
// deplacer chaque piece dans un id dans une case pae exemple rook = id 0
    private static Board initialisationOfPiecesInBoard() {
