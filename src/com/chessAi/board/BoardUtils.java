...
import com.chessAi.pieces.King;
import com.chessAi.pieces.Piece;

import java.util.*;

import static com.chessAi.board.Move.MoveFactory;

//Dans cette classe je vais mettre tous les mothodes qui sont static et qui je vais les utilisers apres
...
// les colonnes
    ...
    // on cheque si le calcule de la piece n'est pas dehors du chess board
    public static boolean isValidTileCoordinate(final int coordinate) {
        return coordinate >= START_TILE_INDEX && coordinate < NUM_TILES;
    }
// avoir les cordonne de la piece dans une position
    public int getCoordinateAtPosition(final String position) {
        return POSITION_TO_COORDINATE.get(position);
    }
// avoir la position d'une piece a partie des cordonnes
